  ...
  <div>
    ...
    <el-form ref="form"
      ...
      <el-form-item label="域名地址"
                    style="width:400px"
                    required="required">
        <el-input v-model="form.Jdomain"
                  placeholder="如：www.baidu.com"></el-input>
      </el-form-item>
      <el-form-item label="请求地址"
                    style="width:1000px"
                    required="required">
        <el-input v-model="form.Jurl"
                  placeholder="如：https://www.baidu.com/"></el-input>
      </el-form-item>
      <el-form-item label="请求协议"
                    required="required">
        <el-select v-model="form.Jprotocol"
                   placeholder="请选择协议">
      ...
      <el-form-item label="请求方法"
                    required="required">
        <el-select v-model="form.Jmethod"
      ...
      <el-checkbox :disabled="false" label="bodydata" name="bodydata"></el-checkbox>
        ...
        <el-radio v-model="form.Jrequest"
                  label="parameters">parameters</el-radio>
        <el-radio v-model="form.Jrequest"
                  label="bodydata">bodydata</el-radio>
      </el-form-item>
      <el-form-item label="请求内容"
                    required="required">
        <el-input type="textarea"
                  v-model="form.Jcontent"
                  placeholder="request内容、body内容"></el-input>
      </el-form-item>
    ...
    <el-input v-model="form.Jcheck" placeholder="如：code:0"></el-input>
      ...
      <el-form-item label="总线程数"
                    style="width:400px"
                    required="required">
        <el-input v-model="form.Jthread"
                  placeholder="最大线程数"></el-input>
      </el-form-item>
      <el-form-item label="ramp up"
                    style="width:1000px"
                    required="required">
        <el-input v-model="form.Jrampup"
                  placeholder="启动时间"></el-input>
      </el-form-item>
      <el-form-item label="持续时间"
                    style="width:400px"
                    required="required">
        <el-input v-model="form.Jduration"
                  placeholder="运行时间"></el-input>
      </el-form-item>
      <el-form-item>
        <el-button type="primary"
                   @click="actionyongli(form.Jmethod, form.Jurl, form.Jdomain, form.Jprotocol,
      form.Jduration, form.Jrampup, form.Jthread, form.Jrequest, form.Jcontent,form.Jcheck)">开始执行</el-button>
        <el-button type="primary"
                   @click="resetForm();lookreport('HTTP', 'HTTP', '5s',form.Jduration)">实时报告</el-button>
      </el-form-item>
    </el-form>
    <!-- <h4>压测报告</h4> -->
    <div>
